        ...
        <div>
          <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <div className="container">
              <Link className="navbar-brand" to="/">AFS Spend</Link>
              ...
              <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div className="navbar-nav">
                  ...
                  { (auth) ? <Link className="nav-item nav-link" to="/checkout">Checkout</Link>: ''}
                  {
                   ...
                   {  ( <Link className="nav-item nav-link float-right" to="/customer">Customer</Link> )
}
                </div>
              </div>
            </div>
          ...
          <div className="container">
            ...
            { (auth) ? <Route exact path="/customer" component={Customer} /> : '' }
          </div>
        </div>
      </Router>
    );
