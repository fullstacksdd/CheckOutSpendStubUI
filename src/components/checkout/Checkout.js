...
export default class Checkout extends React.Component {
	...
	render() {
		...
		window.localStorage.setItem('basket', JSON.stringify(this.state));
		return (
			<div className=" container">
				...
				<Link to="/customer"><button className="btn btn-success float-right" style={{ marginRight: "10px" }}>Payment</button></Link>
